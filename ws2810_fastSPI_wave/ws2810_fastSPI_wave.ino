  ...
  //for(int j = 0; j < 3; j++ ) { 
    ...
    do
    {
      if(leds[ln_LEDNumberInString].r < int_EndColor_r) 
          {
            leds[(ln_LEDNumberInString+1)%(NUM_LEDS-1)].r++;
            leds[ln_LEDNumberInString].r++;
            leds[abs(ln_LEDNumberInString-1)].r++;
            
          }
      else if(leds[ln_LEDNumberInString].r > int_EndColor_r) 
      {
        leds[(ln_LEDNumberInString+1)%(NUM_LEDS-1)].r--;
        leds[ln_LEDNumberInString].r--;
        leds[abs(ln_LEDNumberInString-1)].r--;
      } 
      if(leds[ln_LEDNumberInString].g < int_EndColor_g) 
          {
            leds[(ln_LEDNumberInString+1)%(NUM_LEDS-1)].g++;
            leds[ln_LEDNumberInString].g++;
            leds[abs(ln_LEDNumberInString-1)].g++;
            
          }
      else if(leds[ln_LEDNumberInString].g > int_EndColor_g) 
      {
        leds[(ln_LEDNumberInString+1)%(NUM_LEDS-1)].g--;
        leds[ln_LEDNumberInString].g--;
        leds[abs(ln_LEDNumberInString-1)].g--;
      } 
      if(leds[ln_LEDNumberInString].b < int_EndColor_b) 
          {
            leds[(ln_LEDNumberInString+1)%(NUM_LEDS-1)].b++;
            leds[ln_LEDNumberInString].b++;
            leds[abs(ln_LEDNumberInString-1)].b++;
            
          }
      else if(leds[ln_LEDNumberInString].b > int_EndColor_b) 
      {
        leds[(ln_LEDNumberInString+1)%(NUM_LEDS-1)].b--;
        leds[ln_LEDNumberInString].b--;
        leds[abs(ln_LEDNumberInString-1)].b--;
...
//      else if(leds[ln_LEDNumberInString].b > int_EndColor_b) leds[ln_LEDNumberInString].b--;
    ...
    do
    {
      ...
      else if(leds[ln_LEDNumberInString].r < int_StartColor_r) 
      {
        leds[(ln_LEDNumberInString+1)%(NUM_LEDS-1)].r++;
        leds[ln_LEDNumberInString].r++;
        leds[abs(ln_LEDNumberInString-1)].r++;
      ...
      if(leds[ln_LEDNumberInString].g > int_StartColor_g) 
          {
            leds[(ln_LEDNumberInString+1)%(NUM_LEDS-1)].g--;
            leds[ln_LEDNumberInString].g--;
            leds[abs(ln_LEDNumberInString-1)].g--;
      ...
      else if(leds[ln_LEDNumberInString].g < int_StartColor_g) 
      {
        leds[(ln_LEDNumberInString+1)%(NUM_LEDS-1)].g++;
        leds[ln_LEDNumberInString].g++;
        leds[abs(ln_LEDNumberInString-1)].g++;
      ...
      if(leds[ln_LEDNumberInString].b > int_StartColor_b) 
          {
            leds[(ln_LEDNumberInString+1%NUM_LEDS-1)].b--;
            leds[ln_LEDNumberInString].b--;
            leds[abs(ln_LEDNumberInString-1)].b--;
      ...
      else if(leds[ln_LEDNumberInString].b < int_StartColor_b) 
      {
        leds[(ln_LEDNumberInString+1)%(NUM_LEDS-1)].b++;
        leds[ln_LEDNumberInString].b++;
        leds[abs(ln_LEDNumberInString-1)].b++;
